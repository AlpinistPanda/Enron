...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{n}{tester}\PY{o}{.}\PY{n}{test\PYZus{}classifier}\PY{p}{(}\PY{n}{adaBoostClass}\PY{p}{,} \PY{n}{data\PYZus{}dict}\PY{p}{,} \PY{n}{feature3}\PY{p}{)}
\end{Verbatim}
...
AdaBoostClassifier(algorithm='SAMME.R', base\_estimator=None,
          learning\_rate=1.0, n\_estimators=50, random\_state=None)
	Accuracy: 0.83721	Precision: 0.40439	Recall: 0.29500	F1: 0.34114	F2: 0.31187
	Total predictions: 14000	True positives:  590	False positives:  869	False negatives: 1410	True negatives: 11131
...
scalars}\label{th-stage---feature-scalars}
